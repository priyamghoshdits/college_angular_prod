"use strict";
(self["webpackChunkRUDKARSH"] = self["webpackChunkRUDKARSH"] || []).push([["default-node_modules_ngx-dropzone_fesm2020_ngx-dropzone_mjs"],{
...
/* harmony export */ });
/* harmony import */ var D_xampp_htdocs_college_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
...
class NgxDropzonePreviewComponent {
  ...
  readFile() {
    var _this = this;
    return (0,D_xampp_htdocs_college_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class NgxDropzoneComponent {
  ...
  extractFilesFromDirectory(directory) {
    ...
    function _getFileFromFileEntry() {
      _getFileFromFileEntry = (0,D_xampp_htdocs_college_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fileEntry) {
        try {
    ...
    return new Promise((resolve, reject) => {
      ...
      const readEntries = () => {
        dirReader.readEntries( /*#__PURE__*/function () {
          var _ref = (0,D_xampp_htdocs_college_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dirItems) {
            if (!dirItems.length) {
              resolve(files);
            } else {
...
//# sourceMappingURL=default-node_modules_ngx-dropzone_fesm2020_ngx-dropzone_mjs.4cc75a342dcebf51.js.map